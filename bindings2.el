...
(global-set-key      (kbd "s-å") 'dropdown-multiterm)
(global-set-key      (kbd "s-Å") 'dropdown-multiterm-right)
(global-set-key   (kbd "<s-backspace>") 'murder-buffer-with-window)
...
(global-set-key     (kbd "C-s-r")   'kill-symbol-at-point)
...
(global-set-key     (kbd "s-t")   'avy-goto-word-or-subword-1)               ;;;
...
(global-set-key   (kbd "C-S-t")   'mc/mark-next-like-this)
                          ;-t      ~
...
(global-set-key   (kbd "C-s-i")   'kill-inner)
(global-set-key     (kbd "M-i")   'counsel-imenu)                            ;;;
(global-set-key     (kbd "s-i")    nil)
(global-set-key   (kbd "C-S-i")   'tab-to-tab-stop)
(global-set-key   (kbd "C-M-i")   'my-increment-number-decimal)
...
(global-set-key (kbd "C-x C-d")   'benjamin/insert-dashes)
                          ;-d      :
...
(global-set-key   (kbd "C-M-g")   'dropdown-multiterm-prev)
...
(global-set-key   (kbd "s-h u")   'counsel-unicode-char)
(global-set-key   (kbd "s-h b")   'counsel-descbinds)
                          ;-h     {

(global-set-key     (kbd "s-j")    nil)
(global-set-key     (kbd "C-j")   'next-line)
(global-set-key     (kbd "H-j")    nil)
...
(global-set-key     (kbd "M-b")   'undo-tree-undo)
(global-set-key     (kbd "M-S-b") 'undo-tree-redo)
...
(global-set-key   (kbd "C-x m")   'hydra-toggle/body)                        ;;;
(global-set-key   (kbd "C-S-m")   'mark-line)
(global-set-key   (kbd "C-c m")   'helm-global-mark-ring) ;; soudns dope, FIXME
